...
<html lang="en">
  ...
  <body>
      ...
      <ul class="nav__links">
        ...
        <li class="link"><a href="#explore">Trainers</a></li>
        <li class="link"><a href="#appointment">Appointments</a></li>
      </ul>
    </nav>
      ...
      <section id="home">
        ...
        <section id="appointment">
            <section class="section__container appointment__container">
              ...
              <div class="appointment__grid">
                ...
                <div class="appointment__card">
                  ...
                  <a href="cancel_appointment.php">Click here<i class="ri-arrow-right-line"></i></a>
                </div>
...
<section id="explore">
    ...
    <div class="explore__card">
        ...
        <a href="add_trainer.php">Click here<i class="ri-arrow-right-line"></i></a>
      </div>
      <div class="explore__card">
        <h4>Update Trainers</h4>
        <p>
          Through a combination of workout routines and expert guidance, we'll
          empower you to reach your goals.
        </p>
        <a href="update_trainer.php">Click here<i class="ri-arrow-right-line"></i></a>
      </div>
      <div class="explore__card">
        <h4>Remove Trainers</h4>
        <p>
          Through a combination of workout routines and expert guidance, we'll
          empower you to reach your goals.
        </p>
        <a href="remove_trainer.php">Click here<i class="ri-arrow-right-line"></i></a>
      </div>
      <div class="explore__card">
        <h4>View Trainers</h4>
        <p>
...
<section id="inquiry">
    <section class="section__container inquiry__container">
        <div class="inquiry__header">
          <h2 class="section__header">Make Announcement for coustermers</h2>
